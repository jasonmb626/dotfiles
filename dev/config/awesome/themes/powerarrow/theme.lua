...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ screen = s, width = "99%", y = "2.5%", height = dpi(20), bg = theme.bg_normal, fg = theme.fg_normal, opacity=0.7,
	...
	{ -- Right widgets
	    mytextclock,
	    layout = wibox.layout.fixed.horizontal,
	    wibox.container.margin(s.mytaglist, dpi(10), dpi(10)),
